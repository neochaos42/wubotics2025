...
sys.path.append(os.path.join(get_package_share_directory('my_bot'), 'launch'))
import rs_launch
...
local_parameters = [{'name': 'camera_name',         'default': 'camera', 'description': 'camera unique name'},
                    ...
                    {'name': 'config_file',         'default': [ThisLaunchFileDir(), "/config/realsense.yaml"], 'description': 'yaml config file'},
                   ]
